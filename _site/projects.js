 ...
 $(document).ready(function() {
  ...
  const titles = [
    ...
    const descriptions = [
        ...
        "<b>Fighting and exploring game </b> <br> A <b> Godot </b> based game where the player must fight off enemies and complete multiple levels. <br> Collaborators: M. Garza and S. Mohan ",
